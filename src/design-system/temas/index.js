...
export const portfolioThemes = {
  ...
  hotelaria: {
    ...
    sidebar: "#7A1928",
    sidebarText: "#FFF8F4",
    gradient: "linear-gradient(135deg, #C65A11 0%, #B54A1C 52%, #8B1E2D 100%)",
    description: "Gestão integrada de reservas, hóspedes, acomodações, recepção, governança e faturamento, com identidade visual quente e premium.",
  },
  governamental: {
