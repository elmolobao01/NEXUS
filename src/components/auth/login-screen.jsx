  ...
  return (
    <main className="login-page">
      <section className="login-brand-panel">
        ...
        <div className="login-security-note"><span>✓</span><div><strong>Ambientes separados</strong><small>Administração PLENIUM e operação dos clientes usam layouts, menus e escopos distintos.</small></div></div>
      </section>

      <section className="login-form-panel">
        <form className="login-card" onSubmit={entrar}>
          <span className="eyebrow">Acesso à plataforma</span>
          <h2>Entrar no PLENIUM</h2>
          ...
          <label className="form-field"><span>E-mail</span><input type="email" defaultValue={tipo === "admin" ? "admin@pleniumgestao.com.br" : "gestor@cliente.com.br"} /></label>
          <label className="form-field"><span>Senha</span><input type="password" defaultValue="plenium-demo" /></label>
