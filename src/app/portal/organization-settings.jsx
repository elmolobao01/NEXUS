...
export default function OrganizationSettings({ organization, organizationId }) {
  ...
  return <>
    <section className="client-section-intro"><div><span className="eyebrow">CONFIGURAÇÃO SOB MEDIDA</span><h2>Configurações da organização</h2><p>Estruture identidade, unidades e parâmetros que definem como o PLENIUM funciona para sua realidade.</p></div></section>
