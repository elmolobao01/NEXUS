...
const products = [
  ...
  },
  {
    ...
    features: ["Multi-IA", "PLENIUM Knowledge", "Acesso inteligente às principais IAs"],
    ...
    <main className="nexus-home">
      ...
      <section className="nexus-home-hero">
        <div className="home-hero-copy">
          ...
          <p>Contrate somente o que precisa hoje e amplie seu PLENIUM quando quiser. Gestão e IA funcionam de forma independente — e juntas entregam ainda mais valor.</p>
          <div className="home-hero-actions">
            <a className="home-primary-button" href="#produtos">Conhecer soluções</a>
            <a className="home-secondary-button" href={whatsappUrl("Olá! Conheci o PLENIUM pelo site e gostaria de entender qual solução é mais adequada para mim.")} target="_blank" rel="noreferrer">Falar no WhatsApp</a>
          </div>
        ...
        <div className="home-hero-visual" aria-hidden="true">
          ...
          <div className="home-brand-showcase"><img src="/branding/plenium-instagram.png" alt="PLENIUM — Ecossistema de Soluções" /></div>
        </div>
      </section>

      <section className="home-section" id="produtos">
        <div className="home-section-heading"><span>SOLUÇÕES PLENIUM</span><h2>Escolha como começar.</h2><p>Cada produto pode ser contratado separadamente. Ao combinar soluções, o cliente recebe condições exclusivas do Ecossistema PLENIUM.</p></div>
      ...
      <section className="home-how" id="como-funciona">
        ...
        <div className="home-how-grid">
          <article><b>01</b><h3>Escolha</h3><p>Selecione PLENIUM Gestão, PLENIUM IA ou combine os dois.</p></article>
      ...
      <section className="home-section home-plans" id="planos">
        <div className="home-section-heading"><span>PLANOS PLENIUM</span><h2>Escolha o pacote ideal para o seu momento.</h2><p>Comece com a estrutura necessária hoje e evolua quando precisar. A contratação acontece somente depois da escolha do plano.</p></div>
        <div className="home-plans-grid">
          <article className="home-plan-card"><span className="product-eyebrow">PLENIUM GESTÃO</span><h3>Planos de Gestão</h3><p>Opções para pequenos, médios e grandes negócios, em qualquer segmento.</p><div className="plan-free-badge">IMPLANTAÇÃO GRÁTIS</div><ul><li>✓ Formação técnica inclusa</li><li>✓ Suporte técnico incluso</li><li>✓ Estrutura modular e escalável</li></ul><Link className="home-primary-button" href="/contratar?produto=gestao">Conhecer planos de Gestão</Link></article>
          <article className="home-plan-card"><span className="product-eyebrow">PLENIUM IA</span><h3>Planos de Inteligência</h3><p>Acesso inteligente às principais IAs e recursos de conhecimento.</p><div className="plan-free-badge">CONFIGURAÇÃO GRÁTIS</div><ul><li>✓ Formação para utilização inclusa</li><li>✓ Suporte técnico incluso</li><li>✓ Multi-IA + PLENIUM Knowledge</li></ul><Link className="home-primary-button" href="/contratar?produto=ia">Conhecer planos de IA</Link></article>
        ...
        <p className="home-business-message"><strong>Estrutura de grandes organizações, acessível para negócios de todos os tamanhos.</strong><br/>Sua empresa não precisa ser grande para ter uma grande gestão. Comece com o que precisa hoje e amplie seu PLENIUM conforme o negócio cresce.</p>
      </section>

      <section className="home-contact" id="atendimento">
        <div><span className="home-kicker">ATENDIMENTO PLENIUM</span><h2>Ainda tem dúvidas?</h2><p>Converse com nosso atendimento pelo WhatsApp para esclarecer funcionalidades, planos, contratação ou expansão do seu ambiente.</p></div>
        <a className="home-whatsapp-button" href={whatsappUrl("Olá! Preciso de ajuda para entender as soluções PLENIUM.")} target="_blank" rel="noreferrer">Conversar pelo WhatsApp</a>
      </section>
      ...
      <a className="home-whatsapp-float" href={whatsappUrl("Olá! Vim pelo site da PLENIUM e gostaria de atendimento.")} target="_blank" rel="noreferrer" aria-label="Falar com a PLENIUM pelo WhatsApp">WA</a>
    </main>
  );
}
