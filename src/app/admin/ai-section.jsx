...
export default function AISection() {
  ...
  return (
    <div className="ai2-shell">
      ...
      {tab === "Consumo" && <section className="ai2-panel"><header><div><span>PLENIUM AI · v0.9.2</span><h3>Centro de Custos e Rentabilidade</h3><p>Separa custo faturado do custo econômico de referência para medir o benefício real de Free Tier e preparar a escala.</p></div></header>
        ...
        <h4>Rentabilidade por cliente e plano</h4>
