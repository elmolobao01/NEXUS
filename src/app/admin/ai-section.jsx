...
export default function AISection() {
  ...
  return (
    <div className="ai2-shell">
      ...
      {tab === "Consumo" && <section className="ai2-panel"><header><div><span>PLENIUM AI · v0.9</span><h3>Centro de Custos e Rentabilidade</h3><p>Separa custo faturado do custo econômico de referência para medir o benefício real de Free Tier e preparar a escala.</p></div></header>
        <div className="ai2-metrics">
          ...
          <article><span>Economia Free Tier</span><strong>{usd(data?.economics?.savingsMonthUsd, 6)}</strong><small>{pct(data?.economics?.freeShare)} das operações de custo</small></article>
